                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    @foreach($db_get_1 as $value)
                                        <form action="./reserveringen/edit" method="post">
                                            {{csrf_field()}}
                                            <input type="text" name="idr" value="{{$value->id}}" style="display:none"/>
                                        <tr>
                                            ...
                                            <td><label class="badge badge-success" style="cursor: pointer;"><button type="submit" style="border:none; background-color: transparent; color:white;">Bewerken</button></label></td>
                                        </tr>
                                        </form>
                                    @endforeach
                                    </tbody>
